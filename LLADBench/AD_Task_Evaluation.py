    ...
    def parse_single_generated_predictions(self, sample, id):
        ...
        try:
            ...
            try:
                ...
                match = re.compile(
                    r"""
                    (?:["']answer["'])      # key "answer" (single or double quotes)
                    \s*:\s*                 # colon (spaces allowed)
                    (?:                     # three possible value forms
                    "([^"]*)"            # 1) double-quoted value -> group 1
                    | '([^']*)'            # 2) single-quoted value -> group 2
                ...
                print("Final attempt to get answer:", Answer)
